...
def point_to_elligator_squared(point: tuple[int, int], a: int, b: int, prime: int):
    """
...
def elligator_squared_to_point(encoded_point: tuple[int, int], a: int, b: int, prime: int):
...
encoded_point = point_to_elligator_squared(P, secp256r1_a, secp256r1_b, secp256r1_p)
recovered_point = elligator_squared_to_point(encoded_point, secp256r1_a, secp256r1_b, secp256r1_p)
